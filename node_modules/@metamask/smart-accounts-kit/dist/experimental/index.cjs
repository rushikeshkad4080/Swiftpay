...
var DelegationStorageClient = class {
  ...
  async getDelegationChain(leafDelegationOrDelegationHash) {
    const leafDelegationHash = typeof leafDelegationOrDelegationHash === "string" ? leafDelegationOrDelegationHash : _chunkHJETDDBNcjs.getDelegationHashOffchain.call(void 0, leafDelegationOrDelegationHash);
  ...
  async storeDelegation(delegation) {
    ...
    const delegationHash = _chunkHJETDDBNcjs.getDelegationHashOffchain.call(void 0, delegation);
